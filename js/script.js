...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var audios_loaded = false; // aframe elements 
  ...
  const $opt_links = $("#menu .opt_links"); // on all assets loaded
  ...
  const show = function () {
    $loading.removeClass("show").addClass('hidden'); // show text
    setTimeout(() => {
  ...
  $(document).bind("tap", hideText); // document.body.addEventListener('tap', e => { hideText(e) });
